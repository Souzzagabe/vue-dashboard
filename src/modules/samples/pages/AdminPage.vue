...
const stats = computed(() => {
  ...
  const totalTodos = state.users.reduce(
    (sum, u) => sum + u.total_todos,
    0
  )
      ...
      <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        >
          <template v-if="state.isLoading">
            <div class="mx-auto h-3 w-20 rounded skeleton"></div>
            <div class="mx-auto mt-2 h-8 w-12 rounded skeleton"></div>
          </template>
        ...
        >
          <template v-if="state.isLoading">
            <div class="mx-auto h-3 w-28 rounded skeleton"></div>
            <div class="mx-auto mt-2 h-8 w-12 rounded skeleton"></div>
          </template>
      ...
      <div class="overflow-x-auto rounded-xl border border-gray-800">
        <table class="w-full text-left text-sm">
          ...
          <tbody
            ...
            class="divide-y divide-gray-800 bg-gray-950"
          >
            <tr
              v-for="index in 5"
              :key="index"
            >
              ...
              <!-- Tarefas -->
              <td class="px-4 py-4">
                <div class="h-4 w-8 rounded skeleton"></div>
              </td>
              ...
              <td class="px-4 py-4">
                <div class="flex justify-end gap-2">
                  <div class="h-7 w-28 rounded-lg skeleton"></div>
                  <div class="h-7 w-16 rounded-lg skeleton"></div>
                </div>
              </td>
            </tr>
          </tbody>
