...
/**
 * Quando o usuário volta do OAuth do Google,
 * o backend já deve ter criado o cookie HttpOnly.
 *
 * Aqui restauramos a sessão no Pinia antes de continuar.
 */
onMounted(async () => {
    try {
...
/**
 * Após o cadastro (POST /users), a API não loga
 * o usuário automaticamente.
 *
 * Então preenchemos os campos e fazemos o login normal.
 */
...
<template>
    ...
    >
        <div
            class="w-full max-w-md bg-gray-900 border border-gray-800 rounded-2xl shadow-xl p-8"
        >
            <!-- REGISTER -->
            <RegisterForm
                v-if="mode === 'register'"
            ...
            >
                ...
                <div
                    v-if="error"
                    class="bg-red-500/10 border border-red-500 text-red-400 text-sm p-2 rounded"
                >
                    {{ error }}
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <path
                            fill="#34A853"
                            d="M12 24c3.24 0 5.95-1.08 7.93-2.91l-3.86-3c-1.07.72-2.44 1.16-4.07 1.16-3.13 0-5.78-2.11-6.73-4.96H1.29v3.09C3.26 21.3 7.31 24 12 24z"
                        />
