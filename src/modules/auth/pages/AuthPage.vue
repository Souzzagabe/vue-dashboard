...
const isExchangingGoogle = ref(
  !!route.query.googleToken
)
...
async function exchangeGoogleToken(token: string) {
  try {
    ...
    // Remove o googleToken da URL antes de navegar
    await router.replace(redirect)
  } catch (e) {
    console.error('Erro ao trocar Google token:', e)
...
onMounted(() => {
  const googleToken = route.query.googleToken
